...
#%% Unit 1.2
convert('solutions/2_pathpy.ipynb', 'code/2_pathpy.py', blank_code=True, todo_msg=None)
extract_code('solutions/2_pathpy.ipynb', 'live_solutions/2_pathpy_code.py')
remove_code('solutions/2_pathpy.ipynb', 'code/2_pathpy.ipynb')
convert('solutions/2_pathpy.ipynb', 'solutions/2_pathpy.py', blank_code=False, todo_msg=None)

#%% Unit 1.3
convert('solutions/3_higher_order.ipynb', 'code/3_higher_order.py', blank_code=True, todo_msg=None)
extract_code('solutions/3_higher_order.ipynb', 'live_solutions/3_higher_order_code.py')
remove_code('solutions/3_higher_order.ipynb', 'code/3_higher_order.ipynb')
convert('solutions/3_higher_order.ipynb', 'solutions/3_higher_order.py', blank_code=False, todo_msg=None)

#%% Unit 1.4
convert('solutions/4_temporal_networks.ipynb', 'code/4_temporal_networks.py', blank_code=True, todo_msg=None)
extract_code('solutions/4_temporal_networks.ipynb', 'live_solutions/4_temporal_networks_code.py')
remove_code('solutions/4_temporal_networks.ipynb', 'code/4_temporal_networks.ipynb')
convert('solutions/4_temporal_networks.ipynb', 'solutions/4_temporal_networks.py', blank_code=False, todo_msg=None)

#%% Unit 1.5
convert('solutions/5_exploration.ipynb', 'code/5_exploration.py', blank_code=False, todo_msg=None)
convert('solutions/5_exploration.ipynb', 'solutions/5_exploration.py', blank_code=False, todo_msg=None)

#%% Unit 1.6
convert('solutions/6_multi_order.ipynb', 'code/6_multi_order.py', blank_code=True, todo_msg=None)
extract_code('solutions/6_multi_order.ipynb', 'live_solutions/6_multi_order_code.py')
remove_code('solutions/6_multi_order.ipynb', 'code/6_multi_order.ipynb')
convert('solutions/6_multi_order.ipynb', 'solutions/6_multi_order.py', blank_code=False, todo_msg=None)

#%% Unit 1.7
convert('solutions/7_optimal_analysis.ipynb', 'code/7_optimal_analysis.py', blank_code=True, todo_msg=None)
extract_code('solutions/7_optimal_analysis.ipynb', 'live_solutions/7_optimal_analysis_code.py')
remove_code('solutions/7_optimal_analysis.ipynb', 'code/7_optimal_analysis.ipynb')
convert('solutions/7_optimal_analysis.ipynb', 'solutions/7_optimal_analysis.py', blank_code=False, todo_msg=None)

#%% Unit 1.8
convert('solutions/8_exploration.ipynb', 'code/8_exploration.py', blank_code=False, todo_msg=None)
convert('solutions/8_exploration.ipynb', 'solutions/8_exploration.py', blank_code=False, todo_msg=None)
